    ...
    <Paper elevation={3} sx={{ p: 2, mt: 2 }}>
      ...
      <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        ...
        <Button
          ...
          onClick={handleOpen}
        >
          Add confidential statements
        </Button>
      </Box>

      {/* Notes Table or Empty State with a little gap (mt:2) */}
      <Box sx={{ mt: 2 }}>
        {notes.length === 0 ? (
          <Box sx={{ backgroundColor: "#F5F5F5", padding: 2, textAlign: "center", mb: 2 }}>
...
export default ConfidentialStatement;
